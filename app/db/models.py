...
class DailyProductFeature(Base):
    ...
    news_count_1d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    event_count_1d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    event_count_7d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    event_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    bullish_event_count_7d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    bearish_event_count_7d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    mixed_event_count_7d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    export_restriction_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    import_policy_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    war_logistics_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    weather_disaster_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    crop_report_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    biofuel_policy_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    energy_shock_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    demand_shock_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    supply_chain_count_30d: Mapped[int | None] = mapped_column(Integer, nullable=True)
    sentiment_proxy_7d: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    news_as_of_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    news_missing_flags: Mapped[str | None] = mapped_column(Text, nullable=True)
    export_volume_1m: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    export_volume_3m_avg: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    export_volume_12m_sum: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    import_volume_1m: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    ...
    trade_as_of_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    reporting_lag_days: Mapped[int | None] = mapped_column(Integer, nullable=True)
    trade_missing_flags: Mapped[str | None] = mapped_column(Text, nullable=True)
    production_volume: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    domestic_consumption: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    food_use: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    feed_use: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    ...
    report_published_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    supply_demand_as_of_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    supply_demand_reporting_lag_days: Mapped[int | None] = mapped_column(Integer, nullable=True)
    supply_demand_missing_flags: Mapped[str | None] = mapped_column(Text, nullable=True)
